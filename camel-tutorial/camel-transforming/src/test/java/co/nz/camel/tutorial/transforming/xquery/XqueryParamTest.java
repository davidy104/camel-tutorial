...
public class XqueryParamTest {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(XqueryParamTest.class);
	...
	public void testXqueryParam() throws Exception {
		...
		String response = template.requestBodyAndHeader("direct:xqpStart",
		...
		response = template.requestBodyAndHeader("direct:xqpStart", request,
